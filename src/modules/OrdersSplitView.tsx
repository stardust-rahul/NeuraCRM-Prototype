    ...
    <div className="flex flex-col gap-6 mt-4">
      {orders.map(order => (
        <Card key={order.id} className="relative bg-gradient-to-br from-white to-blue-50 border border-blue-100 shadow-md">
          <button
            className="absolute top-3 right-3 text-blue-600 hover:text-blue-900 rounded-full p-2 focus:outline-none focus:ring-2 focus:ring-blue-400 border border-blue-100 bg-white shadow-sm z-10"
            title="Edit Order"
